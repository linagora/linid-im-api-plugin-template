...
public class MyPluginProviderPlugin implements ProviderPlugin {
  ...
  @Override
  public DynamicEntity create(final ProviderConfiguration configuration, final DynamicEntity dynamicEntity) {
    log.info("Creating new entity on provider 'MyPlugin'");
    return null;
  }

  @Override
  public DynamicEntity update(final ProviderConfiguration configuration, final String id, final DynamicEntity dynamicEntity) {
    log.info("Updating entity on provider 'MyPlugin'");
    return null;
  }

  @Override
  public DynamicEntity patch(final ProviderConfiguration configuration, final String id, final DynamicEntity dynamicEntity) {
    log.info("Patching entity on provider 'MyPlugin'");
    return null;
  }

  @Override
  public boolean delete(final ProviderConfiguration configuration, final String id) {
    log.info("Delete entity on provider 'MyPlugin'");
    return false;
  }

  @Override
  public DynamicEntity findById(final ProviderConfiguration configuration, final String id) {
    log.info("Finding entity by id on provider 'MyPlugin'");
    return null;
  }

  @Override
  public Page<DynamicEntity> findAll(final ProviderConfiguration configuration,
